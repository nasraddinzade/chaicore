...
$DEFAULT_SETTINGS = [
  ...
  /* Цвета сайта — можно перекрасить всю палитру (текст, элементы, фоны) */
  'col_navy'      => ['g'=>'Цвета сайта','l'=>'Фон — основной (тёмный)','t'=>'color','default'=>'#090126'],
  'col_navy2'     => ['g'=>'Цвета сайта','l'=>'Фон — секции (светлее)','t'=>'color','default'=>'#0e0535'],
  'col_navy3'     => ['g'=>'Цвета сайта','l'=>'Фон — карточки','t'=>'color','default'=>'#160a45'],
  'col_crimson'   => ['g'=>'Цвета сайта','l'=>'Красный акцент (кнопки)','t'=>'color','default'=>'#a6142f'],
  'col_crimson2'  => ['g'=>'Цвета сайта','l'=>'Красный — ярче','t'=>'color','default'=>'#c41a39'],
  'col_orange'    => ['g'=>'Цвета сайта','l'=>'Оранжевый — главный акцент','t'=>'color','default'=>'#d97823'],
  'col_orange2'   => ['g'=>'Цвета сайта','l'=>'Оранжевый — ярче','t'=>'color','default'=>'#e8922e'],
  'col_orangedim' => ['g'=>'Цвета сайта','l'=>'Оранжевый — приглушённый (подписи)','t'=>'color','default'=>'#8a4b10'],
  'col_cream'     => ['g'=>'Цвета сайта','l'=>'Кремовый — заголовки','t'=>'color','default'=>'#f2c299'],
  'col_cream2'    => ['g'=>'Цвета сайта','l'=>'Кремовый — светлее','t'=>'color','default'=>'#fad5b5'],
  'col_text'      => ['g'=>'Цвета сайта','l'=>'Текст — основной','t'=>'color','default'=>'#d4b89a'],
  'col_textdim'   => ['g'=>'Цвета сайта','l'=>'Текст — приглушённый','t'=>'color','default'=>'#8a6d55'],
