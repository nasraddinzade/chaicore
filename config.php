...
defined('DB_NAME') || define('DB_NAME', 'u838968544_chaicore12');        // база на Hostinger
defined('DB_USER') || define('DB_USER', 'u838968544_chaicore');          // пользователь базы
defined('DB_PASS') || define('DB_PASS', 'Chaicore12');                   // пароль базы
